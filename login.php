                    ...
                    <div class="login-form col-lg-3 col-md-4 col-sm-12">
                        <form class="form_container" action="login.php" id="form-login" method="POST">
                            ...
                            <div class="input_container">
                                ...
                                <input placeholder="Nhập mã người dùng" title="Inpit title" name="madangnhap" type="text" class="input_field" id="madangnhap" />
                            ...
                            <div class="input_container">
                                ...
                                <input placeholder="Nhập mật khẩu" title="Inpit title" name="matkhau" type="password" class="input_field" id="password" />
                            </div>
                            ...
                            <?php
                            // if(isset($_POST['madangnhap'])){
                            //     if($_POST['madangnhap']=="" || $_POST['matkhau'] ==""){
