...
if (isset($_POST['madangnhap']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($data && $data['ma_nguoidung'] != null) {
        ...
        setcookie('ma_nguoidung', $user['ma_nguoidung'], time() + (60 * 60), "/");
        $_SESSION['ma_nguoidung'] = $user['ma_nguoidung'];
        $_SESSION['vaitro'] = $role;
        $_SESSION['hoten'] = $user['hoten'];
        $_SESSION['ma_nganh'] = $user['ma_nganh'];
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-9 col-md-8 col-sm-12">
                        <div class="view-news">
                            <h5 class="">THÔNG BÁO - TIN TỨC</h5>

                            <div class="tab-news">
                                <div class="list-notifi">
                                    <div class="notifi-item">
                                        <div class="notifi-time">2021-12-01</div>
                                        <div class="notifi-content">
                                            <a href="">
                                                <p class="title-notifi">
                                                    THÔNG TIN MỚI NHẤT VỀ ĐĂNG KÝ KHÓA LUẬN KHOA CNTT
                                                    NGÀNH IS (2023 - 2024)
                                                </p>
                                            </a>
                    ...
                    <div class="login-form col-lg-3 col-md-4 col-sm-12">
                        <form class="form_container" action="login.php" id="form-login" method="POST">
                            <div class="logo_container">
                                <img class="img-logo" src="./Uploads/Logo-IUH.jpg" alt="" />
                            </div>
                            <div class="title_container">
                                <p class="title">HỆ THỐNG QUẢN LÝ KHÓA LUẬN</p>
                            </div>

                            <div class="input_container">
                                <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
                                    <path stroke-linejoin="round" stroke-linecap="round" stroke-width="1.5" stroke="#141B34" d="M7 8.5L9.94202 10.2394C11.6572 11.2535 12.3428 11.2535 14.058 10.2394L17 8.5">
                                    </path>
                                ...
                                <input placeholder="Nhập mã người dùng" title="Inpit title" name="madangnhap" value="" type="text" class="input_field" id="madangnhap" />
                            ...
                            <div class="input_container d-flex">
                                ...
                                <input placeholder="Nhập mật khẩu" title="Inpit title" name="matkhau" type="password" value="" class="input_field" id="password" />
                                <i class="fa-solid fa-eye icon" style="margin-left: 220px;" id="showpass" onclick="showPassword()"> </i>
                            ...
                            <span class="subtitle">Nếu không đăng nhập được vui lòng liên hệ qua email:
                                quantriht@gmail.com</span>
