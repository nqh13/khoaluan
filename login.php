                    ...
                    <div class="login-form col-lg-3 col-md-4 col-sm-12">
                        <form class="form_container" action="login.php" id="form-login" method="POST">
                            ...
                            <div class="input_container">
                                ...
                                <input placeholder="Nhập mã người dùng" title="Inpit title" name="madangnhap" value=""
                                    type="text" class="input_field" id="madangnhap" />
                            ...
                            <div class="input_container d-flex">
                                ...
                                <input placeholder="Nhập mật khẩu" title="Inpit title" name="matkhau" type="password"
                                    value="" class="input_field" id="password" />
                                <i class="fa-solid fa-eye icon" style="margin-left: 220px;" id="showpass"
