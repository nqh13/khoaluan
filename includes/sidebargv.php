                ...
                <ul id="myAccordion" class="nav flex-column flex-nowrap retro-link-text w-100">
                    ...
                    <li class="nav-item border-bottom">
                        ...
                        <div id="item-3" class="collapse show">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link pl-5" href="?page=danhgia">Đánh giá & Điểm số </a>
                                </li>
                    ...
                    <li class="nav-item border-bottom">
                        ...
                        <div id="item-2" class="collapse show">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link pl-5 accordion-toggle collapsed " href="?page=taothaoluan"
                                        data-parent="#item-2">
                                        Tạo thảo luận mới</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link pl-5 accordion-toggle collapsed " href="?page=thaoluan"
                                        data-parent="#item-2">
