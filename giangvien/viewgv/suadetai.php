...
<div class="content mt-1">
    ...
    <form action="" method="post" class="formdetai" id="" style="padding:10px;" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="tendetai" id="tendetai" aria-describedby="helpId" value="<?php echo $result['tendetai'] ?>" placeholder="Tên đề tài">
            <small id="erTen" class="form-text "></small>
        </div>
        <div class="form-group">
            <label class="font-weight-bold" for="">Mô tả đề tài</label>
            <input type="text" class="form-control" name="mota" id="mota" aria-describedby="helpId" placeholder="Mô tả đề tài" value="<?php echo $result['mota'] ?>">
            <small id="erThanhPhan" class="form-text "></small>
        </div>
        <div class="form-group">
            <label class="font-weight-bold" for="">Yêu cầu </label>
            <input type="text" class="form-control" name="yeucau" id="yeucau" aria-describedby="helpId" placeholder="Yêu cầu đề tài" value="<?php echo $result['yeucau'] ?>">
            <small id="erMoTa" class="form-text "></small>
        </div>
        <div class="form-group">
            <label class="font-weight-bold" for="">Kiến thức & Kỹ năng</label>
            <input type="text" class="form-control" name="kienthuc" id="kienthuc" aria-describedby="helpId" placeholder="Kiến thức thực hiện đề tài" value="<?php echo $result['kienthuc'] ?>">
