                ...
                <ul id="myAccordion" class="nav flex-column flex-nowrap retro-link-text w-100">
                    ...
                    <li class="nav-item border-bottom">
                        ...
                        <div id="item-2" class="collapse">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link pl-5 accordion-toggle collapsed" href="?page=detai" data-parent="#item-2">
                                        Đề tài đăng ký</a>

                                </li>
                                <li class="nav-item">
                                    <a class="nav-link pl-5 accordion-toggle collapsed" href="?page=baocao" data-parent="#item-2">Báo cáo đề tài</a>

                                </li>
                                <li class="nav-item">
                                    <a class="nav-link pl-5" href="?page=thaoluan">Thảo luận đề tài</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item border-bottom">
                        ...
                        <div id="item-3" class="collapse">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link pl-5" href="?page=diemso">Điểm số</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item border-bottom">
                        ...
                        <div id="item-4" class="collapse">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link pl-5" href="?page=doithongtin">Đổi thông tin cá nhân</a>
                                </li>
                            </ul>
                        </div>
                    </li>
