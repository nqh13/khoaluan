...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
            include("./app/Views/includes/sidebargv.php");
            ...
            <div class="col-lg-10  col-md-10 col-sm-12  main">
                ...
                switch ($page) {
                    case 'danhsach':
                        include("./app/Views/giangvien/danhsachdetai.php");
                        break;
                    case 'themdetai':
                        include("./app/Views/giangvien/themdetai.php");
                        break;
                    case 'capnhat':
                        include("./app/Views/giangvien/suadetai.php");
                        break;
